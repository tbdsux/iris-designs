...
const SubPage = (props: SubPageProps) => {
  return (
    <div className="w-5/6 mx-auto flex flex-col lg:flex-row justify-between py-12">
      <div className="md:w-5/6 lg:w-3/5 mx-auto lg:mr-auto text-center lg:text-left lg:pr-8">
        <h2 className="text-5xl lg:text-6xl font-extrabold text-main">{props.page_title}</h2>
        <p className="text-3xl lg:text-4xl mt-4 text-gray-800 dark:text-gray-300">
      ...
      <div className="mt-4 lg:mt-0 w-11/12 xs:w-5/6 md:w-1/2 lg:w-2/5 flex items-center justify-center">
        <Image alt={`${props.page_title}`} src={`${props.page_image}`} height={450} width={450} />
      </div>
    </div>
  );
};
