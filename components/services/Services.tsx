    ...
    <div className="my-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="p-6 border-2 rounded-lg border-main border-opacity-10 shadow-xl dark:bg-coolGray-800"
          >
            <div className="flex flex-col lg:flex-row items-center text-center lg:text-left">
              ...
              <div className="lg:ml-6">
                ...
                <p className="text-xl mt-2 text-gray-800 dark:text-gray-200">
                  {service.description}
                </p>
              </div>
            </div>
