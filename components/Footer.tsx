			...
			<div className="w-11/12 xl:w-5/6 mx-auto flex flex-col md:flex-row items-center justify-between">
				<div className="flex items-center">
					<Image
						...
						width="40"
					/>
					<h4 className="text-xl ml-2 uppercase text-gray-700 dark:text-gray-300">
						<span className="text-main font-bold">Iris</span>{" "}
						Designs
					</h4>
				</div>
				<ul className="text-lg text-center flex flex-col xs:flex-row md:flex-col lg:flex-row text-gray-700 dark:text-gray-200 my-4 md:my-0">
